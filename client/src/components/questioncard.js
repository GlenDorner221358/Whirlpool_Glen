...
function SingleQuestion() {
    ...
    const handleDelete = async () => {
        try {
            await axios.delete('https://whirlpool-live-334e9800cedf.herokuapp.com/api/deleteQuestion/' + question.id);
            axios.delete('https://whirlpool-live-334e9800cedf.herokuapp.com/api/deleteComments/' + question.title);
    ...
    useEffect(() => {
        axios.get('https://whirlpool-live-334e9800cedf.herokuapp.com/api/singleQuestion/' + question.id)
            .then(res => {
                let data = res.data;
                setWienerBalls(data);
                console.log(JSON.stringify(data.image));

                setQuePic("https://whirlpool-live-334e9800cedf.herokuapp.com/questionImages/" + data.image)
