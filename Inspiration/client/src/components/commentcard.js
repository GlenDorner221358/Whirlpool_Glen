...
function SingleComment() {
    ...
    useEffect(() => {
        axios.get("https://whirlpool-live-334e9800cedf.herokuapp.com/api/comments/" + queTitle)
            .then((res) => {
    ...
    const handleLike = async (commentID, commentLikes) => {
        if (!isLiked) {
            ...
            axios.patch('https://whirlpool-live-334e9800cedf.herokuapp.com/api/updateComment/' + commentID, payload)
                .then(res => {
                    if (res) {
    ...
    const handleDelete = async (commentID) => {
        if (permissions === 'true') {
            try {
                await axios.delete('https://whirlpool-live-334e9800cedf.herokuapp.com/api/deleteComment/' + commentID);
