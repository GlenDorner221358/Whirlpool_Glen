...
function Profile() {
    ...
    useEffect(() => {
        if (userMail) {
            axios.get('https://whirlpool-live-334e9800cedf.herokuapp.com/api/singleUser/' + userMail)
                .then(res => {
                    let data = res.data;
                    setUserData(data);
                    console.log(JSON.stringify(data.profilePic));

                    setUserPic("https://whirlpool-live-334e9800cedf.herokuapp.com/userImages/" + data.profilePic)
    ...
    const changeImg = (e) => {
        ...
        axios.put("https://whirlpool-live-334e9800cedf.herokuapp.com/api/users/profilePic/" + userMail, payloadData)
            .then((res) => {
                if (res) {
    ...
    // edit the users info
    const handleSave = () => {
        axios.put(`https://whirlpool-live-334e9800cedf.herokuapp.com/api/updateUser/${userMail}`, editData)
            .then(res => {
    ...
    const confirmDeleteAccount = () => {
        axios.delete(`https://whirlpool-live-334e9800cedf.herokuapp.com/api/deleteUser/${userMail}`)
            .then((response) => {
