...
function Landing() {
    ...
    useEffect(() => {
        Axios.get('https://whirlpool-live-334e9800cedf.herokuapp.com/api/allQuestions')
            .then(res => {
    ...
    useEffect(() => {
        Axios.get(`https://whirlpool-live-334e9800cedf.herokuapp.com/api/allQuestions?tag=${selectedTag || ''}`)
            .then(res => {
                let productData = res.data;
                let slicedArray = [];
